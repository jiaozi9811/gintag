...
type UserClient interface {
	...
	UserPost(ctx context.Context, in *UserViewRequest, opts ...grpc.CallOption) (*UserPostResponse, error)
...
func (c *userClient) UserPost(ctx context.Context, in *UserViewRequest, opts ...grpc.CallOption) (*UserPostResponse, error) {
...
type UserServer interface {
	...
	UserPost(context.Context, *UserViewRequest) (*UserPostResponse, error)
...
func (UnimplementedUserServer) UserPost(context.Context, *UserViewRequest) (*UserPostResponse, error) {
...
func _User_UserPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UserPost(ctx, req.(*UserViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
